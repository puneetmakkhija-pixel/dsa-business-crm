...
export default async function BillingPage() {
  ...
  const stats: Stat[] = [
    { label: "Match", value: String(flag("match")), sub: "zero variance", glow: "#34D399", icFg: "#34D399", icon: "M20 6L9 17l-5-5" },
    { label: "Minor Variance", value: String(flag("minor")), sub: "< 3% accepted", glow: "#E8B873", icFg: "#E8B873", icon: "M12 8v4M12 16h.01M10.3 3.9L1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z" },
    { label: "Review / Disputed", value: String(flag("review")), sub: "> 3% — auto-disputed", glow: "#FB7185", icFg: "#FB7185", icon: "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0zM12 9v4M12 17h.01" },
    { label: "Reconciled Cases", value: String(reconciled.length), sub: "billing MIS matched", glow: "#5B8DEF", icFg: "#7CA8FF", icon: "M22 12h-4l-3 9L9 3l-3 9H2" },
  ];
